function [closestKp,kpi,closestKi,kii,closestsig,closestf] = quickplot(sweepData,Ki,Kp,switchThresh,sinfreqsDecimate,pureSinTime,KPsel,KIsel,sigSel,fSel,sae)
rat_I = 4.971;
